import { Body, Button, Container, Column, Head, Hr, Html, Img, Link, Preview, Section, Text } from "@react-email/components"
			...
			<Body style={main}>
				<Container style={container}>
					<Section style={box}>
						...
						<Text style={paragraph}>
							Click on the 'Claim your device' button on the home page, and one of our associates will verify and reach back
							out to you with securing your device.
						</Text>
						...
						<Hr style={hr} />
						<Text style={paragraph}>
							We hope we lived up to your expectations. You can also reach out to our support team as well if need be. (link
							on homepage of website within the FAQ section)
						</Text>
						<Text style={paragraph}>
							Please also consider helping us grow, by telling your friends, family,... heck, grab a random person on the
							street (don't actually do this). Believe it or not, the traffic gained helps us continue doing what we're doing.
							Share this email or the link below with a friend or on social media! We really appreciate any and all support!
						</Text>
