	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				't-inner-md': 'inset 0 4px 6px -1px rgba(0, 0, 0, 0.1), inset 0 -2px 4px -1px rgba(0, 0, 0, 0.06)',
				't-inner-lg': 'inset 0 10px 15px -3px rgba(0, 0, 0, 0.1), inset 0 -4px 6px -2px rgba(0, 0, 0, 0.05)',
				't-inner-xl': 'inset 0 20px 25px -5px rgba(0, 0, 0, 0.1), inset 0 -10px 10px -5px rgba(0, 0, 0, 0.04)',
				't-inner-2xl': 'inset 0 25px 50px -12px rgba(0, 0, 0, 0.25)',
				...
				'r-inner-md': 'inset 0 4px 6px -1px rgba(0, 0, 0, 0.1), inset 0 -2px 4px -1px rgba(0, 0, 0, 0.06)',
				'r-inner-lg': 'inset 0 10px 15px -3px rgba(0, 0, 0, 0.1), inset 0 -4px 6px -2px rgba(0, 0, 0, 0.05)',
				'r-inner-xl': 'inset 0 20px 25px -5px rgba(0, 0, 0, 0.1), inset 0 -10px 10px -5px rgba(0, 0, 0, 0.04)',
				'r-inner-2xl': 'inset 0 25px 50px -12px rgba(0, 0, 0, 0.25)',
				...
				'b-inner-md': 'inset 0 4px 6px -1px rgba(0, 0, 0, 0.1), inset 0 -2px 4px -1px rgba(0, 0, 0, 0.06)',
				'b-inner-lg': 'inset 0 10px 15px -3px rgba(0, 0, 0, 0.1), inset 0 -4px 6px -2px rgba(0, 0, 0, 0.05)',
				'b-inner-xl': 'inset 0 20px 25px -5px rgba(0, 0, 0, 0.1), inset 0 -10px 10px -5px rgba(0, 0, 0, 0.04)',
				'b-inner-2xl': 'inset 0 25px 50px -12px rgba(0, 0, 0, 0.25)',
				...
				'l-inner-md': 'inset 0 4px 6px -1px rgba(0, 0, 0, 0.1), inset 0 -2px 4px -1px rgba(0, 0, 0, 0.06)',
				'l-inner-lg': 'inset 0 10px 15px -3px rgba(0, 0, 0, 0.1), inset 0 -4px 6px -2px rgba(0, 0, 0, 0.05)',
				'l-inner-xl': 'inset 0 20px 25px -5px rgba(0, 0, 0, 0.1), inset 0 -10px 10px -5px rgba(0, 0, 0, 0.04)',
				'l-inner-2xl': 'inset 0 25px 50px -12px rgba(0, 0, 0, 0.25)',
