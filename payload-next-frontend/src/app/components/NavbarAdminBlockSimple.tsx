...
const NavbarAdminBlockSimple = ({ userDetails }: { userDetails: any }) => {
						...
						<div className="z-50">
							<DropdownMenu>
								<DropdownMenuTrigger asChild>
									<div
										className="cursor-pointer overflow-hidden bg-cover bg-center group z-[12] bg-zinc-700 border-[3px]  border-black hover:outline outline-emerald-400/40 outline-offset-0 rounded-full h-12 w-12 text-bold"
										style={{
								...
								<DropdownMenuContent
									className={`${
										userDetails.isAdmin ? "pt-12" : "pt-4"
									} fixed -right-4 min-w-64 px-4 pb-4 rounded-2xl shadow-2xl bg-white dark:bg-gray-800 dark:text-white dark:border-zinc-950`}>
									{userDetails.isAdmin && (
										<p className="text-lg w-full absolute top-0 right-0 left-0 px-4 py-1 bg-zinc-200 dark:bg-black/30 text-left text-amber-600">
											Admin
										</p>
									)}
									...
									<div
										...
										<div
											...
											className="h-11 w-11 bg-cover bg-center rounded-full"></div>
										<div className="gap-0">
									...
									<DropdownMenuSeparator />
									<hr className="border-t-2 border-zinc-100 dark:border-zinc-700" />
									<DropdownMenuSeparator />
									<div className="ml-2 gap-4 flex flex-col">
										<div
											id=""
											className="mt-2 gap-6 flex flex-col">
										...
										<div className="cl-userButtonPopoverFooter 🔒️ cl-internal-uyu30o text-zinc-200 justify-center flex mt-4">
											<div className="cl-internal-wkkub3 flex items-center gap-2 -mt-3">
												<p className="cl-internal-td400p dark:opacity-20">
													Secured by
												</p>
												<a
													aria-label="Clerk logo"
													className="cl-internal-1h80eck dark:opacity-20"
...
export default NavbarAdminBlockSimple
