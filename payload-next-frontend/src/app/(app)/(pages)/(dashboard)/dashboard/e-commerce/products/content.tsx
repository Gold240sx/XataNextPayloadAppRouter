...
const ECommerceProductsPageContent: FC<ECommerceProductsPageData> = function ({
	...
	return (
		<>
			<div className="block items-center justify-between border-b px-4 md:px-8 border-gray-200bg-white p-4 sm:flex dark:border-gray-700 dark:bg-gray-800">
				<div className="mb-1 w-full">
					<div className="mb-4">
						<Breadcrumb className="mb-5">
							...
							<Breadcrumb.Item href="/dashboard/e-commerce/products">
								E-commerce
							</Breadcrumb.Item>
