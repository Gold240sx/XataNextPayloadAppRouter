...
const pages: SidebarItem[] = [
	...
	{ href: "/dashboard/kanban", icon: HiViewGrid, label: "Kanban" },
	{
	...
	},
	{
		...
		label: "E-commerce",
		items: [
			{ href: "/dashboard/e-commerce/products", label: "Products" },
			{ href: "/dashboard/e-commerce/billing", label: "Billing" },
			{ href: "/dashboard/e-commerce/invoice", label: "Invoice" },
		],
	},
	{
		icon: HiUsers,
		label: "Users",
		items: [
			{ href: "/dashboard/users/list", label: "Users list" },
			{ href: "/dashboard/users/profile", label: "Profile" },
			{ href: "/dashboard/users/feed", label: "Feed" },
	...
	},
	{
		...
		label: "Pages",
		items: [
			{ href: "/pages/pricing", label: "Pricing", target: "_blank" },
			{
				href: "/pages/maintenance",
				label: "Maintenace",
				target: "_blank",
			},
			{ href: "/pages/404", label: "404 not found", target: "_blank" },
			{ href: "/pages/500", label: "500 server error", target: "_blank" },
		],
	},
	{
		icon: HiLockClosed,
