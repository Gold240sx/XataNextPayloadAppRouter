			...
			<div className="p-5">
				...
				<div className="space-y-2">
					<p className="text-base font-normal text-gray-500 dark:text-gray-400">
						...
						having a new computer? Make your own PC easy and
						compatible!
					</p>
					<p className="text-base font-normal text-gray-500 dark:text-gray-400">
						So insisted received is occasion advanced honoured.
						Among ready to which up. Attacks smiling and may out
						assured moments man nothing outward. Thrown any behind
						afford either the set depend one temper. Instrument
						melancholy in acceptance collecting frequently be if.
						Zealously now pronounce existence add you instantly say
						offending. Merry their far had widen was. Concerns no in
...
const Menu: FC = function () {
	return (
		<div className="block items-center justify-between border-b px-4 md:px-8 border-gray-200 p-4 sm:flex dark:border-gray-700 dark:bg-gray-800">
			<div className="flex items-center divide-x divide-gray-100 dark:divide-gray-700">
				<div className="pr-3">
					<Link
						href="dashboard/mailing/inbox"
		...
		<div className="bottom-0 right-0 w-full border-t border-gray-200 bg-white p-4 lg:fixed lg:pl-64 dark:border-gray-700 dark:bg-gray-800">
			...
			<div className="items-center sm:flex sm:divide-x sm:divide-gray-100 lg:pl-4 dark:divide-gray-700">
				<div className="mb-3 space-y-3 sm:mb-0 sm:flex sm:space-x-3 sm:space-y-0">
					<Button color="primary" href="/dashboard/mailing/reply">
